...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "The Civil Code of the Philippines, the old Spanish Civil Code; Rep Act No. 386",  # noqa: E501
            [
                {"cat": "ra", "id": "386"},
                {"cat": "ra", "id": "386"},
                {"cat": "spain", "id": "civil"},
...
@pytest.mark.parametrize(
    ...
    [
        (
            "A.M. No. 02-11-10-SC or the Rules on Declaration of Absolute; Administrative Order No. 3 by enacting A.M. No. 99-10-05-0; Parenthetically, under these statutes [referring to RA Nos. 965 and 2630], Commonwealth Act (C.A.) No. 613, otherwise known as the <em>Philippine Immigration Act of 1940</em>",  # noqa: E501
            [
                {
                    "cat": "rule_am",
                    "id": "02-11-10-sc",
        ...
        (
            "There is no question that Section 2 of Presidential Decree No. 1474 is inconsistent with Section 62 of Republic Act No. 3844.; Petitioner’s case was decided under P.D. No. 971, as amended by P.D. No. 1707.",  # noqa: E501
            [
                {"cat": "pd", "id": "1474"},
                {"cat": "ra", "id": "3844"},
                {"cat": "pd", "id": "971"},
        ...
        (
            "Nonetheless, the Court has acknowledged the practical value of the process of marking the confiscated contraband and considered it as an initial stage in the chain of custody - a process preliminary and preparatory to the physical inventory and photograph requirements in Section 21 of Republic Act No. 9165:",  # noqa: E501
            [{"cat": "ra", "id": "9165"}],
        ),
        (
            "As amended by Republic Act No. 9337- An Act Amending Sections 27, 28, 34, 106, 107, 108, 109, 110, 111, 112, 113, 114, 116, 117, 119, 121, 148, 151, 236, 237 and 288 of the National Internal Revenue Code of 1997",  # noqa: E501
            [{"cat": "ra", "id": "9337"}],
        ),
    ],
)
